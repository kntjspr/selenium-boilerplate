...
# Custom chromdriver, browser and user data path
...
# Remove "profile.managed_default_content_settings.images" if you wish to enable images. Disabled on default for data saving.
prefs = {
